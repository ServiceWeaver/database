...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "bankofanthos_prototype/bankofanthos/userservice/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, createUserMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/userservice/T", Method: "CreateUser", Remote: false}), loginMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/userservice/T", Method: "Login", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, createUserMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/userservice/T", Method: "CreateUser", Remote: true}), loginMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/userservice/T", Method: "Login", Remote: true})}
		},
