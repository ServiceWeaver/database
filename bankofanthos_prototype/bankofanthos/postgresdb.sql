...
CREATE INDEX IF NOT EXISTS fromIdx ON transactions (from_acct, from_route, timestamp);
CREATE INDEX IF NOT EXISTS toIdx ON transactions (to_acct, to_route, timestamp);
