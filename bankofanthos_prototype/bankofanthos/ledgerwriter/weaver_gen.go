...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "bankofanthos_prototype/bankofanthos/ledgerwriter/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, addTransactionMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/ledgerwriter/T", Method: "AddTransaction", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, addTransactionMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/ledgerwriter/T", Method: "AddTransaction", Remote: true})}
		},
		...
		RefData: "⟦7237a6f4:wEaVeReDgE:bankofanthos_prototype/bankofanthos/ledgerwriter/T→bankofanthos_prototype/bankofanthos/balancereader/T⟧\n",
	})
}
