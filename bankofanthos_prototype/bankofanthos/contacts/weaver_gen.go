...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "bankofanthos_prototype/bankofanthos/contacts/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, addContactMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/contacts/T", Method: "AddContact", Remote: false}), getContactsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/contacts/T", Method: "GetContacts", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, addContactMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/contacts/T", Method: "AddContact", Remote: true}), getContactsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "bankofanthos_prototype/bankofanthos/contacts/T", Method: "GetContacts", Remote: true})}
		},
